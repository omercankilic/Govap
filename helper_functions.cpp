...
AVFrame* avframeToAvframe(const AVFrame *in_frame,AVPixelFormat target_pix_fmt,AVCodecContext *enc_ctx){
    ...
    uint8_t *dataBuffer = new uint8_t[number_of_bytes*sizeof(uint8_t)];
...
QImage scale_QImg(int width,int height,QImage &in_img){
    QSize qs(width,height);
    QImage new_img = in_img.scaled(qs,Qt::IgnoreAspectRatio,Qt::FastTransformation);
    return new_img;
}
/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
